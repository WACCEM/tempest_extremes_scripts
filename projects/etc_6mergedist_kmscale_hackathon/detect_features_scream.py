...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_6mergedist_kmscale_hackathon/scream_io_config.yaml")
    ...
    config_ETC_DetectNodes    = load_yaml_file('projects/etc_6mergedist_kmscale_hackathon/config_ETC_DetectNodes_noextrawinds.yaml')
    config_ETC_StitchNodes    = load_yaml_file('projects/etc_6mergedist_kmscale_hackathon/config_ETC_StitchNodes_noextrawinds.yaml')
