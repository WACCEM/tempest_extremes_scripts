...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_6mergedist_kmscale_hackathon/icon_io_config.yaml")
    ...
    input_config2 = load_config_and_generate_files("projects/etc_6mergedist_kmscale_hackathon/icon_io_config_pt2.yaml")
