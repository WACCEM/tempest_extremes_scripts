...
#SBATCH --job-name=track_ETCs_scream
#SBATCH --nodes=1
...
datadir=/pscratch/sd/b/beharrop/kmscale_hackathon/hackathon_pre/screamv2_ne120_tracking_etc_6mergedist
name=screamv2_ne120_hp8_hp8
etc_file=${datadir}/screamv2_ne120_hp8.etc_stitched_nodes.filtered_out_tcs.txt
