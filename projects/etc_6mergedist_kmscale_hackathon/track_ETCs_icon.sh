...
#SBATCH --job-name=track_ETCs_icon
#SBATCH --nodes=1
#SBATCH --output=track_ETCs_icon.o%j
#SBATCH --error=track_ETCs_icon.e%j
#SBATCH --time=1:45:00
#SBATCH --qos=regular
...
datadir=/pscratch/sd/b/beharrop/kmscale_hackathon/hackathon_pre/icon_d3hp003_1year_tracking_etc_6mergedist
