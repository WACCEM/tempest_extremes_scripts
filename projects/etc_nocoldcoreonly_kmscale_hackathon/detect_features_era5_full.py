...
def main():
    ...
    input_config2 = load_config_and_generate_files("projects/etc_nocoldcoreonly_kmscale_hackathon/era5_io_config_full.yaml")
    ...
    #config_ETC_VariableProcessor = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_CyclVort850_VariableProcessor.yaml')
