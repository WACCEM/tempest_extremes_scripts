...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_nocoldcoreonly_kmscale_hackathon/era5_io_config_full.yaml")
    ...
    input_config2 = load_config_and_generate_files("projects/etc_nocoldcoreonly_kmscale_hackathon/era5_io_config_pt2.yaml")
    config['input_pr_ws_list'] = input_config2['in_data_list']

    # Load the TC yaml files
    config_TC_DetectNodes     = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_TC_DetectNodes.yaml')
    config_TC_StitchNodes     = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_TC_StitchNodes.yaml')
    config_TC_NodeFileFilter  = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_TC_NodeFileFilter.yaml')
    config_TC_StitchBlobs     = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_TC_StitchBlobs.yaml')

    # Load the AR yaml files
    config_AR_DetectBlobs     = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_AR_DetectBlobs.yaml')
    config_AR_NodeFileFilter  = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_AR_NodeFileFilter.yaml')
    config_AR_StitchBlobs     = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_AR_StitchBlobs.yaml')

    # Load the ETC yaml files
    config_ETC_DetectNodes       = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_ETC_DetectNodes.yaml')
    config_ETC_StitchNodes       = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ETC_StitchNodes.yaml')
    config_ETC_NodeFileFilter    = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_ETC_NodeFileFilter.yaml')
    config_ETC_StitchBlobs       = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ERA5_ETC_StitchBlobs.yaml')
