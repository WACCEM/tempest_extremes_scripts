...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_nocoldcoreonly_kmscale_hackathon/nicam_io_config.yaml")
    ...
    input_config2 = load_config_and_generate_files("projects/etc_nocoldcoreonly_kmscale_hackathon/nicam_io_config_pt2.yaml")
    ...
    config_ETC_DetectNodes    = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ETC_3D_DetectNodes.yaml')
