...
def main():
    ...
    config_ETC_DetectNodes    = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ETC_DetectNodes_noextrawinds.yaml')
    config_ETC_StitchNodes    = load_yaml_file('projects/etc_nocoldcoreonly_kmscale_hackathon/config_ETC_StitchNodes_noextrawinds.yaml')
