...
datadir=/pscratch/sd/b/beharrop/kmscale_hackathon/hackathon_pre/casesm2_10km_nocumulus_tracking
name=casesm2_10km_nocumulus_hp8_H
storm_file=${datadir}/casesm2_10km_nocumulus_hp8.etc_stitched_nodes.txt
