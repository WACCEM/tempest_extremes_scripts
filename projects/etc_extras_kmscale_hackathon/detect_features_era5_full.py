...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_extras_kmscale_hackathon/era5_io_config_full.yaml")
    ...
    input_config2 = load_config_and_generate_files("projects/etc_extras_kmscale_hackathon/era5_io_config_full.yaml")
    config['input_pr_ws_list'] = input_config2['in_data_list']


    # Load the ETC yaml files
    config_ETC_DetectNodes       = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ERA5_ETC_DetectNodes.yaml')
    config_ETC_StitchNodes       = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ETC_StitchNodes.yaml')
    #config_ETC_NodeFileFilter    = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ERA5_ETC_NodeFileFilter.yaml')
    #config_ETC_VariableProcessor = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ERA5_CyclVort850_VariableProcessor.yaml')
    #config_ETC_StitchBlobs       = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ERA5_ETC_StitchBlobs.yaml')
