...
def main():
    ...
    input_config  = load_config_and_generate_files("projects/etc_extras_kmscale_hackathon/era5_io_config.yaml")
    ...
    input_config2 = load_config_and_generate_files("projects/etc_extras_kmscale_hackathon/era5_io_config.yaml")
    ...
    #config_ETC_NodeFileFilter    = load_yaml_file('projects/etc_extras_kmscale_hackathon/config_ERA5_ETC_NodeFileFilter_vortblobs.yaml')
